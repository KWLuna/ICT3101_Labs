...
#line hidden
#line 12
 await testRunner.ThenAsync("the addition result should be 120", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
...
#line hidden
#line 19
  await testRunner.ThenAsync(string.Format("the addition result should be {0}", value3), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }

...
#line hidden
        ...
        public virtual async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UsingCalculatorDivision", "\t\tIn order to conquer divisions\r\n\t\tAs a division enthusiast\r\n\t\tI wat to understan" +
                    "d a variety of division operations", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 9
  await testRunner.WhenAsync("I have entered 1 and 2 into the calculator and press divide", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
  await testRunner.ThenAsync("the division result should be 0.5", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
...
#line hidden
#line 15
  await testRunner.WhenAsync("I have entered 0 and 15 into the calculator and press divide", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
  await testRunner.ThenAsync("the division result should be 0", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
#line 21
  await testRunner.WhenAsync("I have entered 15 and 0 into the calculator and press divide", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 22
  await testRunner.ThenAsync("the division result equals positive_infinity", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
#line 27
  await testRunner.WhenAsync("I have entered 0 and 0 into the calculator and press divide", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 28
  await testRunner.ThenAsync("the division result should be 1", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
